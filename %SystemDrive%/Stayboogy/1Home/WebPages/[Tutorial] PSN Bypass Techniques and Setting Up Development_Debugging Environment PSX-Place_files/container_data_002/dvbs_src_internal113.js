...
function O(b,d){a:{var f={};try{if(b&&b.performance&&b.performance.getEntries){var c=b.performance.getEntries();for(b=0;b<c.length;b++){var e=c[b],m=e.name.match(/.*\/(.+?)\./);if(m&&m[1]){var g=m[1].replace(/\d+$/,""),h=d[g];if(h){for(var q=0;q<h.stats.length;q++){var n=h.stats[q];f[h.prefix+n.prefix]=Math.round(e[n.name])}delete d[g];if(!G(d))break}}}}var l=f;break a}catch(z){}l=void 0}if(l&&G(l))return l}function P(b,d){function f(b){var c=n,e;for(e in b)b.hasOwnProperty(e)&&(c+=["&"+e,"="+b[e]].join(""));
...
hasPassback:!1,tagAdTag:d,tagPassback:f}};return e(b)}function I(b,d,f,c,e,m,g,h,q,n,l,z){d.dvregion=0;var u=dv_GetParam(k,"useragent");k=window._dv_win.$dvbs.CommonData;if(void 0!=k.BrowserId&&void 0!=k.BrowserVersion&&void 0!=k.BrowserIdFromUserAgent)var p={ID:k.BrowserId,version:k.BrowserVersion,ID_UA:k.BrowserIdFromUserAgent};else p=T(u?decodeURIComponent(u):navigator.userAgent),k.BrowserId=p.ID,k.BrowserVersion=p.version,k.BrowserIdFromUserAgent=p.ID_UA;var r="";void 0!=d.aUrl&&(r="&aUrl="+d.aUrl);
var A="";try{c.depth=U(c);var w=V(c,f,p);if(w&&w.duration){var v="&dvp_strhd="+w.duration;v+="&dvpx_strhd="+w.duration}w&&w.url||(w=W(c));w&&w.url&&(r="&aUrl="+encodeURIComponent(w.url),A="&aUrlD="+w.depth);var y=c.depth+e;m&&c.depth--}catch(H){v=A=r=y=c.depth=""}a:{try{if("object"==typeof window.$ovv||"object"==typeof window.parent.$ovv){var t=1;break a}}catch(H){}t=0}e=function(){function b(e){c++;var d=e.parent==e;return e.mraid||d?e.mraid:20>=c&&b(e.parent)}var e=window._dv_win||window,c=0;try{return b(e)}catch(fa){}}();
...
navigator.platform);v&&(t+=v);u&&(t+="&useragent="+u);p&&(t+="&brid="+p.ID+"&brver="+p.version+"&bridua="+p.ID_UA);t+="&dup="+dv_GetParam(k,"dup");try{t+=dv_AppendIQPAParams(k)}catch(H){}(l=dv_GetParam(k,"turl"))&&(t+="&turl="+l);(l=dv_GetParam(k,"tagformat"))&&(t+="&tagformat="+l);"video"===dv_GetParam(k,"tagtype")&&(t+="&DVP_BYPASS219=1");t+=X();n=n?"&dvf=0":"";l=M("maple")?"&dvf=1":"";c=(window._dv_win.dv_config.verifyJSURL||"https://"+(window._dv_win.dv_config.bsAddress||"rtb"+d.dvregion+".doubleverify.com")+
"/verify.js")+"?flvr=0&jsCallback="+d.callbackName+"&jsTagObjCallback="+d.tagObjectCallbackName+"&num=6"+t+"&srcurlD="+c.depth+"&ssl="+d.ssl+n+l+"&refD="+y+d.tagIntegrityFlag+d.tagHasPassbackFlag+"&htmlmsging="+(g?"1":"0")+"&tstype="+J(window._dv_win);(g=dv_GetDynamicParams(k,"dvp").join("&"))&&(c+="&"+g);(g=dv_GetDynamicParams(k,"dvpx").join("&"))&&(c+="&"+g);if(!1===h||q)c=c+("&dvp_isBodyExistOnLoad="+(h?"1":"0"))+("&dvp_isOnHead="+(q?"1":"0"));f="srcurl="+encodeURIComponent(f);(h=Y())&&(f+="&ancChain="+
...
b.document;if(e&&e.referrer){var m=e.referrer.replace(/\//g,"\\/").replace(/\./g,"\\."),g=new RegExp('(?:w{0,4}=")?'+m+"[^&\"; %,'\\$\\\\\\|]+","gi");d=/banner|adprefs|safeframe|sandbox|sf\.html/gi;f=/^\w{0,4}="/gi;var h=K(e,"script","src",g,d,f);if(!h){var q=e.referrer;c="";var n=e.getElementsByTagName("script");if(n)for(m=0;!c&&m<n.length;){var l=n[m].innerHTML;if(l&&-1!=l.indexOf(q)){var z=l.match(g);c=L(z,d,f)}m++}(h=c)||(h=K(e,"a","href",g,d,f))}e=htmlUrl=h;a:{if(b.performance&&b.performance.mark&&
b.performance.measure&&b.performance.getEntriesByName){b.performance.mark("dv_str_html_end");b.performance.measure("dv_str_html","dv_str_html_start","dv_str_html_end");var u=b.performance.getEntriesByName("dv_str_html");if(u&&0<u.length){var p=u[0].duration.toFixed(2);break a}}p=null}return{url:e,depth:-1,duration:p}}}catch(r){}return null}function L(b,d,f){var c="";if(b&&0<b.length)for(var e=0;e<b.length;e++){var m=b[e];m.length>c.length&&null==m.match(d)&&0!=m.indexOf('src="')&&0!=m.indexOf('turl="')&&
...
!window._dv_win.dvbsProcessed||0==window._dv_win.dvbsScriptsInternal.length)return{isSev1:!1,url:null};e=window._dv_win.dv_config&&window._dv_win.dv_config.isUT?window._dv_win.dvbsScriptsInternal[window._dv_win.dvbsScriptsInternal.length-1]:window._dv_win.dvbsScriptsInternal.pop();h=e.script;this.dv_script_obj=e;this.dv_script=h;window._dv_win.dvbsProcessed.push(e);window._dv_win._dvScripts.push(h);g=h.src;this.dvOther=0;this.dvStep=1;var n=window._dv_win.dv_config?window._dv_win.dv_config.dv_GetRnd?
window._dv_win.dv_config.dv_GetRnd():C():C();e=window.parent.postMessage&&window.JSON;var l={};try{for(var v=/[\?&]([^&]*)=([^&#]*)/gi,u=v.exec(g);null!=u;)"eparams"!==u[1]&&(l[u[1]]=u[2]),u=v.exec(g);var p=l}catch(r){p=l}this.tagParamsObj=p;p.perf=this.perf;p.uid=n;p.script=this.dv_script;p.callbackName="__verify_callback_"+p.uid;p.tagObjectCallbackName="__tagObject_callback_"+p.uid;p.tagAdtag=null;p.tagPassback=null;p.tagIntegrityFlag="";p.tagHasPassbackFlag="";0==(null!=p.tagformat&&"2"==p.tagformat)&&
(u=S(p.script),p.tagAdtag=u.tagAdTag,p.tagPassback=u.tagPassback,u.isBadImp?p.tagIntegrityFlag="&isbadimp=1":u.hasPassback&&(p.tagHasPassbackFlag="&tagpb=1"));u=(/iPhone|iPad|iPod|\(Apple TV|iOS|Coremedia|CFNetwork\/.*Darwin/i.test(navigator.userAgent)||navigator.vendor&&"apple, inc."===navigator.vendor.toLowerCase())&&!window.MSStream;p.protocol="https:";p.ssl="1";g=p;(n=window._dv_win.dvRecoveryObj)?("2"!=g.tagformat&&(n=n[g.ctx]?n[g.ctx].RecoveryTagID:n._fallback_?n._fallback_.RecoveryTagID:1,
1===n&&g.tagAdtag?document.write(g.tagAdtag):2===n&&g.tagPassback&&document.write(g.tagPassback)),g=!0):g=!1;if(g)return{isSev1:!0};this.dvStep=2;R(p);h=h&&h.parentElement&&h.parentElement.tagName&&"HEAD"===h.parentElement.tagName;this.dvStep=3;return I(this,p,b,d,f,c,e,!0,h,u,q,m)};this.sendRequest=function(b){var d=dv_GetParam(b,"tagformat");if(v)try{v.setVersionData(this.getVersionParamName(),this.getVersion()),d&&"2"==d?$dvbs.domUtilities.addScriptResource(b,document.body,v.onLoad,v.onError,v.uniqueKey):
...
window._dv_win.frames[c.name].document)?h:null}if(q)q.open(),q.write(f);else{try{document.domain=document.domain}catch(l){}var n=encodeURIComponent(f.replace(/'/g,"\\'").replace(/\n|\r\n|\r/g,""));c.src='javascript: (function(){document.open();document.domain="'+window.document.domain+"\";document.write('"+n+"');})()"}}}catch(l){f=window._dv_win.dv_config=window._dv_win.dv_config||{},f=dv_getDVBSErrAddress(f),c=[this.getVersionParamName(),this.getVersion()].join("="),f+=["/verify.js?flvr=0&ctx=818052&cmp=1619415&dvp_cert=3&num=6",
c].join("&"),dv_SendErrorImp(f,[{dvp_jsErrMsg:"DvFrame: "+encodeURIComponent(l)}])}return!0};this.isApplicable=function(){return!0};this.onFailure=function(){};window.debugScript&&(window.CreateUrl=I);this.getVersionParamName=function(){return"ver"};this.getVersion=function(){return"161"}};
