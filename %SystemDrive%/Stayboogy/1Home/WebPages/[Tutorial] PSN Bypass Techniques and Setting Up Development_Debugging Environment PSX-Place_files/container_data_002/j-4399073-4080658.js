//Generated:2022-10-07 19:19:02// 6-271
(function() {
  var o = {
    $: function(el) {
      var x = el || o.divID,
  ...
  var data = {
    params: window.ftParams_4399073 || '',
    guid: window.ftGUID_4399073 || '',
    confID: window.ftConfID_4399073 || '0',
    ftReturn: window.ftReturn_4399073 || '',
    keyword: window.ftKeyword_4399073 || '',
    ftId: window.ftId_4399073 || '',
    ftImpId: window.ftImp4399073 && window.ftImp4399073.impID || '',
    gdpr: window.ftImp4399073 && window.ftImp4399073.gdpr || '',
    gdpr_consent: window.ftImp4399073 && window.ftImp4399073.gdpr_consent || '',
    gdpr_pd: window.ftImp4399073 && window.ftImp4399073.gdpr_pd || '',
    us_privacy: window.ftImp4399073 && window.ftImp4399073.us_privacy || '',
    campaignID: '115749',
    cID: '116264',
    pID: '4399073',
    creativeID: '4080658',
    ...
    extscript: [
      "https://cdn.doubleverify.com/dvtp_src.js?ctx=1828362&cmp=115749&sid=18330&plc=4399073&num=&adid=&advid=&adsrv=29&btreg=4399073&btadsrv=flashtalking&crt=4080658&crtname=&chnl=&unit=&pid=&uid=&dvtagver=6.1.src&dvp_ftimpid=[FT_IMPRESSIONID]&auevent=[ftqs:[ft_dv]]"
    ],
    clickTags: ["https://servedby.flashtalking.com/click/8/115749;4399073;4080658;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display"], 
    statBaseURL: 'http://stat.flashtalking.com/reportV3/ft.stat?224721968-4399073;4080658;',
    centreAd: false,
    width: 728,
    height: 90,
    adType: 'custom_rule'.toLowerCase(),
    altimg: 'http://cdn.flashtalking.com/xre/439/4399073/4080658/image/4080658.gif',
    viewableImpressionURL: 'https://servedby.flashtalking.com/imp/8/115749;4399073;202;pixel;DV360;DV360FY20AcrobatCTXCustomAffinityBlendedUSDSKBAN728x90/?',
    stump: 'https://servedby.flashtalking.com',
    altimghref: "https://servedby.flashtalking.com/click/8/115749;4399073;4080658;211;[FT_CONFID]/?g=[FT_GUID]&random=[FT_RANDOM]&ft_width=728&ft_height=90&url=https://www.adobe.com/acrobat/free-trial-download.html?sdid=7RZ367W3&mv=display",
    divID: 'ftdiv4399073',
    altimgID: 'ftalt4399073',
    alttext: 'Click here',
    w: window,
    adDisplayed: false,
    customPos: false,
    ...
    append: !!(window.ftImp4399073 && parseInt(window.ftImp4399073.jsAppend, 10) === 1),
    ...
    secure: !!(location.protocol === 'https:' || /^https:/.test((document.getElementById('ftscript_m4399073') || {}).src) || window.qs && typeof qs.get === 'function' && /^https:/.test(qs.get('ifsrc', ''))),
    scriptLocation: document.getElementById('ftscript_m4399073'),
    pageVisible: 'maybe',
...
(function(o) {
    ...
    o.frameID = 'ftframe4399073';
    o.file = 'http://cdn.flashtalking.com/116264/4080658/index.html';
    o.altImg = 'https://servedby.flashtalking.com/imp/8/115749;4399073;204;gif;DV360;DV360FY20AcrobatCTXCustomAffinityBlendedUSDSKBAN728x90/?';
...
(function(o) {
	if (o.width === 1 && o.height === 2){
		o.addEventListener("obaEnd", function(){
		    try {
		        document.getElementById("ftAdChoices_4399073").style.display = "none";

		    } catch(e){
		        window.parent.document.getElementById("ftAdChoices_4399073").style.display = "none";
		    }
		});
	}
}(ft4399073));
...
(function(o){
    ...
    var scriptToFire = "https://js.ad-score.com/score.min.js?pid=1000557&tt=g#tid=13539&l1=115749&l2=DV360&l3=4399073&l4=4080658&l5=&l6=&utid=[%FT_IMPRESSIONID%]&cb=[%random%]";
    var pixelToFire = "https://img-1000557.ad-score.com/img?pid=1000557&tid=13539&tt=g&l1=115749&l2=DV360&l3=4399073&l4=4080658&utid=[%FT_IMPRESSIONID%]&creative_type=display&cb=[%random%]";
...
(function(o) {
  ...
  // var windowDvVariable = window.ftClick_4399073;
  var windowDvVariable = "",
      // windowFtParams = window.ftParams_6001356;
      windowFtParams = window.ftParams_4399073;
